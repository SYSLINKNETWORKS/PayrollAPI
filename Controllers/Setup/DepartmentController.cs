...
namespace TWP_API_Payroll.Controllers {
    ...
    public class DepartmentController : ControllerBase {
        private readonly IProcessor<DepartmentBaseModel> _IProcessor = null;
        ...
        ///</summary>
        [HttpGet]
        public async Task<IActionResult> GetDepartment (Guid _MenuId) {
            try {
        ...
        public async Task<IActionResult> GetDepartmentById ([FromHeader] Guid _MenuId,[FromHeader]  Guid _Id) {
            try {
        ...
        ///</summary>
        [HttpPost]
        public async Task<IActionResult> AddDepartment ([FromBody] DepartmentAddModel model) {
            try {
        ...
        ///</summary>
        [HttpDelete]
        public async Task<IActionResult> DeleteDepartment ([FromBody] DepartmentDeleteModel model) {
            try {
