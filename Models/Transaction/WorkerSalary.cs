...
namespace TWP_API_Payroll.Models
{
    ...
    public partial class WorkerSalary
    {
        ...
        public int ResignDays { get; set; } //employee_salary_Worker_resign_days
        public int JoinDays { get; set; } //employee_salary_Worker_join_days
        ...
        public double OvertimeMinutes { get; set; } //employee_salary_Worker_overtime_minutes
        public double OvertimeHours { get; set; } //employee_salary_Worker_overtime_hours
        public double OvertimeDays { get; set; } //employee_salary_Worker_overtime_days
        public double LateMinutes { get; set; } //employee_salary_Worker_late_minutes
        public double LateHours { get; set; } //employee_salary_Worker_late_hours
        public double LateDays { get; set; } //employee_salary_Worker_late_days
        public double LateDaysTotal { get; set; } //employee_salary_Worker_late_days_Total
        public double AbsentMinutes { get; set; } //employee_salary_Worker_absent_minutes
        public double AbsentHours { get; set; } //employee_salary_Worker_absent_hours
        public double OvertimeRate { get; set; } //employee_salary_Worker_overtime_rate
        public double OvertimeActual { get; set; } //employee_salary_Worker_overtime_actual
        public double OvertimeActualAmount { get; set; } //employee_salary_Worker_overtime_actual_amount
        public double AbsentDaysActual { get; set; } //employee_salary_Worker_absentdays_actual
        public double AbsentDaysActualAmount { get; set; } //employee_salary_Worker_absentdays_actual_amount
        public double LateDaysActual { get; set; } //employee_salary_Worker_latedays_actual
        public double LateDaysActualAmount { get; set; } //employee_salary_Worker_latedays_actual_amount
        public double Amount { get; set; } //employee_salary_Worker_amount
        public double GrossAmount { get; set; } //employee_salary_Worker_amount_gross
        public double PayableAmount { get; set; } //employee_salary_Worker_amount_payable
