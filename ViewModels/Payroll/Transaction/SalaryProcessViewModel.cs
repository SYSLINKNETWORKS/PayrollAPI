...
{
    public class SalaryProcessBaseModel {

    }
    public class SalaryProcessStaffModel : SalaryProcessBaseModel {
    ...
    public class SalaryProcessWorkerModel : SalaryProcessBaseModel {
